...
public class QLearningStateNode {
  ...
  /**
   * Creates a new object for the given hashed state. The list of {@link burlap.behavior.valuefunction.QValue} objects is initialized to be
   * empty.
   *
  ...
  public void addQValue(Action a, double q) {
    QValue qv = new QValue(state.s(), a, q);
    qEntry.add(qv);
  }
