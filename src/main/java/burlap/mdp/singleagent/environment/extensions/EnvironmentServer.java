...
/**
 * A {@link EnvironmentServerInterface} implementation that delegates all {@link burlap.mdp.singleagent.environment.Environment}
 * interactions and request to a provided {@link burlap.mdp.singleagent.environment.Environment} delegate. This class will also intercept
 * all interactions through the {@link #executeAction(Action)} and {@link #resetEnvironment()} methods and tell all
 * {@link burlap.mdp.singleagent.environment.EnvironmentOutcome} instances registered with this server about the event.
 *
...
public class EnvironmentServer implements EnvironmentServerInterface, EnvironmentDelegation {
  ...
  /**
   * the {@link burlap.mdp.singleagent.environment.Environment} delegate that handles all primary
   * {@link burlap.mdp.singleagent.environment.Environment} functionality.
   */
  protected Environment delegate;

  /**
   * The {@link EnvironmentObserver} objects that will be notified of {@link burlap.mdp.singleagent.environment.Environment} events.
   */
  protected List<EnvironmentObserver> observers = new LinkedList<EnvironmentObserver>();

  /**
   * If the input {@link burlap.mdp.singleagent.environment.Environment} is an instance {@link EnvironmentServerInterface}, then all the
   * input observers are added to it and it is returned. Otherwise, a new {@link EnvironmentServer} is created around it, with all of the
   * observers added.
   *
  ...
  /**
   * Constructs an {@link EnvironmentServer} or {@link EnvironmentServer.StateSettableEnvironmentServer}, based on whether the input
   * delegate implements {@link StateSettableEnvironment}.
   *
  ...
  /**
   * Returns the {@link burlap.mdp.singleagent.environment.Environment} delegate that handles all
   * {@link burlap.mdp.singleagent.environment.Environment} functionality
   *
  ...
  /**
   * Sets the {@link burlap.mdp.singleagent.environment.Environment} delegate that handles all
   * {@link burlap.mdp.singleagent.environment.Environment} functionality
   *
