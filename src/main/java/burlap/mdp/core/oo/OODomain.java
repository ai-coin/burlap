...
/**
 * A {@link Domain} for Object-Oriented MDP problems.
 *
...
public interface OODomain extends Domain {
  ...
  /**
   * Returns the Java class used to define an OO-MDP object class with the given name. Note that the OO-MDP class name does not have to
   * match the Java class name.
   *
  ...
  /**
   * Returns a list of the propositional functions that define this domain. Modifying the returned list will not alter the list of
   * propositional functions that define this domain, because it returns a shallow copy. Modifying the propositional functions in the
   * returned list will, however, modify the propositional functions in this domain.
   *
  ...
  /**
   * Add a propositional function that can be used to evaluate objects that belong to object classes of this domain. The function will not
   * be added if this domain already has a instance with the same name.
   *
