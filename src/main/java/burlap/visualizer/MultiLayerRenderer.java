...
/**
 * A MultiLayerRenderer is a canvas that will sequentially render a set of render layers, one on top of the other, to the same 2D graphics
 * context. Rendering is performed offscreen to a buffered image before being displayed on the screen.
 *
...
public class MultiLayerRenderer extends JPanel {
  ...
  /**
   * Removes the render layer at the specified position.
   *
