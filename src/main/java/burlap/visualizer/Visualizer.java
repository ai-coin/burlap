...
/**
 * This class extends the {@link MultiLayerRenderer} class to provide a base instance of a {@link StateRenderLayer} in its render list and
 * provides methods to directly access and interface with the {@link StateRenderLayer} instance.
 * <p>
...
public class Visualizer extends MultiLayerRenderer {
   ...
   * @param afterStateRL if true, then the {@link burlap.visualizer.StateActionRenderLayer} will be drawn after the
   * {@link burlap.visualizer.StateRenderLayer} is drawn If false, then it draws before.
   */
  ...
  /**
   * Updates the state that needs to be painted and repaints. If a {@link burlap.visualizer.StateActionRenderLayer} has been specified, then
   * it will have its state-action cleared before repainting.
   *
  ...
  /**
   * Updates the state and action for the {@link burlap.visualizer.StateRenderLayer} and {@link burlap.visualizer.StateActionRenderLayer};
   * then repaints.
   *
