...
/**
 * This class paints general properties of a state/domain that may not be represented by any specific object instance data. For instance,
 * the GridWorld class may have walls that need to be painted, but the walls are part of the transition dynamics of the domain and not
 * captured in the object instance values assignments.
 *
