...
/**
 * A {@link StatePainter} for painting {@link OOState} instances. Painting is defined by being given a list of OO-MDP class-wise painters
 * and specific instance-wise painters. A class-wise painter will handle painting all OO-MDP objects belonging to a specific OO-MDP class,
 * except for objects that have an associated instance-wise painter, which override any class-wise painters for the painting of the object.
 * <p>
...
public class OOStatePainter implements StatePainter {
  ...
  /**
   * Map of painters that define how to paint specific objects; if an object it appears in both specific and general lists, the specific
   * painter is used
   */
  ...
  /**
   * A pair of the name of an object class to paint, and the {@link burlap.visualizer.ObjectPainter} to use to paint it.
   */
